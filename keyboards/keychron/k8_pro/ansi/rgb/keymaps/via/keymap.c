...
/*  DEFAULT WINDOWS LAYOUT - FOR REFERENCE ONLY:
...
//"Win/Android" Mode:
[WIN_BASE2] = LAYOUT_ansi_87(
     KC_ESC,   KC_F5,    KC_F2,    KC_F3,    KC_F4, LCTL(KC_F5), KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,              KC_PSCR,  KC_BTN1,  KC_MPLY,
     ...
     KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,
     KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,             KC_UP,
     KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                                 KC_RALT,  KC_RGUI,MO(WIN_FN2),KC_RCTL,   KC_LEFT,  KC_DOWN,  KC_RGHT),

[WIN_FN2] = LAYOUT_ansi_87(
     KC_SUNQ,  KC_F1,    KC_BRIU,  KC_TASK,  KC_FILE, LCTL(KC_R),RGB_VAI,  KC_MPRV,  KC_STILL, KC_CLOSE, KC_SPAM,  KC_SPAM2, KC_SPAM3,            KC_ESCAL, KC_CARE,  KC_HELPCARE,
     KC_TRNS,  BT_HST1,  BT_HST2,  BT_HST3,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  RGB_SAD,  RGB_SAI,  KC_DELUP,  KC_MPRV,  KC_MNXT,  KC_TRY,
     RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_ZUKO,  KC_ZUKO2, KC_ZUKO3, KC_ZUKO4,  KC_ZUKO5, KC_AVAIL2,KC_RES,
     KC_TRNS,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_LOOK,
     KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  BAT_LVL,  NK_TOGG,  KC_LOGT,  KC_LOGE,  KC_LOG5,  KC_TAXUP,           KC_PHONE,            RALT(KC_EQL),
     KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_TRNS,                                KC_NGROUP,KC_WGROUP,KC_TRNS,  KC_PUB,    KC_DESKL, RALT(KC_MINS),KC_DESKR),

//FN + R CTRL
/*[WIN_FN3] = LAYOUT_ansi_87(
     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,             KC_TRNS,  KC_TRNS,  KC_TRNS,
     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,  KC_TRNS,
     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,  KC_TRNS,
     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,
     KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,             RALT(KC_EQL),
     KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_TRNS,                                KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  RALT(KC_MINS),KC_TRNS),*/
...
[WIN_FN] = LAYOUT_ansi_87(
     KC_SUNQ,  KC_F1,    KC_BRIU,  KC_TASK,  KC_FILE, LCTL(KC_R),RGB_VAI,  KC_MPRV,  KC_STILL, KC_CLOSE, KC_SPAM,  KC_SPAM2, KC_SPAM3,            KC_ESCAL, KC_CARE,  KC_HELPCARE,
     KC_TRNS,  BT_HST1,  BT_HST2,  BT_HST3,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  RGB_SAD,  RGB_SAI,  KC_TRNS,   KC_MPRV,  KC_MNXT,  KC_TRY,
     RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_ZUKO,  KC_ZUKO2, KC_ZUKO3, KC_ZUKO4,  KC_THX,   KC_HAPPY, KC_SCHED,
     KC_TRNS,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_LOOK,
     KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  BAT_LVL,  NK_TOGG,  KC_LOGT,  KC_LOGE,  KC_LOG5,  KC_PUB,             KC_PHONE,            RGB_HUI,
     KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_TRNS,                                KC_NGROUP,KC_WGROUP,KC_TRNS,  KC_TAXUP,  RGB_SPD,  RGB_HUD,  RGB_SPI)
};
